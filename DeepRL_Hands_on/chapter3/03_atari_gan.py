...
# dimension input vector will be rescaled
IMAGE_SIZE = 64
DISCR_FILTERS = 64
GENER_FILTERS = 64
...
class Discriminator(nn.Module):
    def __init__(self,input_shape):
        ...
        self.conv_pipe = nn.Sequential(
            ...
            nn.Conv2d(in_channels = DISCR_FILTERS,out_channels = 2 * DISCR_FILTERS,
                    kernel_size = 4,stride = 2, padding = 1),
            nn.BatchNorm2d(DISCR_FILTERS * 2),
            nn.ReLU(),

            nn.Conv2d(in_channels = DISCR_FILTERS * 2,out_channels = 4 * DISCR_FILTERS,
                    kernel_size = 4,stride = 2, padding = 1),
            nn.BatchNorm2d(DISCR_FILTERS * 4),
            nn.ReLU(),

            nn.Conv2d(in_channels = DISCR_FILTERS * 4,out_channels = 8 * DISCR_FILTERS,
                    kernel_size = 4,stride = 2, padding = 1),
